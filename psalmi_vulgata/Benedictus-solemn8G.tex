\item Benedíctus Dómi\sylprep{nus}, \sylprep{De}\sylprep{us} \sylac{Is}raël:~* quia visitávit, et fecit redemptiónem \sylprep{ple}\sylprep{bis} \sylac{su}æ:
...
\item Salútem ex in\sylprep{i}\sylprep{mí}\sylprep{cis} \sylac{nos}tris,~* et de manu ómnium, \sylprep{qui} \sylprep{o}\sylac{dé}runt nos.
...
\item Et tu, puer, Prophéta Altís\sylprep{si}\sylprep{mi} \sylprep{vo}\sylac{cá}beris:~* præíbis enim ante fáciem Dómini, paráre \sylprep{vi}\sylprep{as} \sylac{e}jus:
