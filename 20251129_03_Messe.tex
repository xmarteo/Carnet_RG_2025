...
\gscore{in_salve_sancta_parens}{\aa Nous te saluons, ô Mère sainte, qui as mis au monde le Roi qui règne sur le ciel et la terre, dans les siècles des siècles.
\vv De belles paroles jaillissent de mon cœur, je dis mes œuvres au Roi.}

\gscore{ky_K10}{}

\gscore{ky_G10}{Gloire à Dieu, au plus haut des cieux, 
...
Lecture du livre de la Sagesse. \rubric{Si. 24 : 9-12}\\
...
\gscore{gr_benedicta_et_venerabilis}{\rr Tu es bénie et vénérable, Vierge Marie, toi qui, sans avoir rien perdu de ton intégrité corporelle, es devenue la mère du Sauveur. \vv Vierge, Mère de Dieu, celui que l'univers entier ne peut contenir, devenu homme, s'est enfermé dans ton sein.}

\gscore{al_post_partum}{\vv Après l'enfantement, ô Vierge, tu es demeurée inviolée: Mère de Dieu, intercède pour nous, alléluia.}
...
\gscore{of_ave_maria}{\rubric{Lc 1: 28, 42} Je te salue, Marie, pleine de grâce, le Seigneur est avec toi, tu êtes bénie entre toutes les femmes, et le fruit de tes entrailles est béni.}
...
\smallscore{MORXX_Preface}{%TODO préface ton simple ?
\vv Le Seigneur soit avec vous.\\
\rr Et avec votre esprit.\\
...
\gscore{06ky--agnus_dei_xi--solesmes}{Agneau de Dieu, qui enlevez les péchés du monde : ayez pitié de nous.\\
...
\gscore{co_beata_viscera}{\rubric{Ps. 44: 2, 5, 8} \aa Heureuses les entrailles de la Vierge Marie, qui ont porté le Fils du Père éternel.\\
\vv \rubric{\emph{1. }} D'heureuses paroles jaillissent de mon cœur quand je dis mes poèmes pour le roi. \capsaut
\vv \rubric{\emph{2. }} D'une langue aussi vive que la plume du scribe !\capsaut
\vv \rubric{\emph{3. }} Dans ta beauté et ta bonté, marche, glorieuse, avance, et règne.\capsaut
...
\gscore{ky_I9}{\vv Allez, c'est l'envoi. \rr Nous rendons grâces à Dieu.}
