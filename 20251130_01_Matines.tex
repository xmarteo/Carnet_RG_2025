...
\gscore{inv_regem_venturum}{Le Roi qui doit venir, le Seigneur, venez, adorons-le.}

%% TODO ps94

\gscore{hy_verbum_supernum}{}
\hymntranslation{Verbe suprême
...
\bigtitle{Premier nocturne}{Dimanche 30 novembre}{Matines}

\gscore{an_veniet_ecce}{Voici que viendra le Roi, le Très-haut, avec une grande puissance, pour sauver les nations, alléluia.}
\psalmVulgate{1}
\gscore{an_confortate_manus}{Fortifiez les mains languissantes, prenez courage et dites : Voici, notre Dieu viendra, et il nous sauvera, alléluia.}
\psalmVulgate{2}
\gscore{an_gaudete_omnes}{Réjouissez-vous tous et livrez-vous à la joie, car voici que le Seigneur de la vengeance viendra, il amènera la rétribution, il viendra lui-même et nous sauvera.}
\psalmVulgate{3}
...
\bigtitle{Deuxième nocturne}{Dimanche 30 novembre}{Matines}

\gscore{an_gaude_et_laetare}{Réjouis-toi, réjouis-toi, fille de Jérusalem: voici que ton Roi vient à toi: Sion, ne crains pas, car ton salut viendra bientôt.}
\psalmVulgate{8}
\gscore{an_rex_noster_adveniet}{Notre Roi, le Christ, viendra, lui que Jean a prédit être l’Agneau qui doit venir.}
\psalmVulgate{9-i}
\gscore{an_ecce_venio}{Voici que je viens bientôt, et ma récompense est avec moi, dit le Seigneur ; c’est de donner à chacun selon ses œuvres.}
\psalmVulgate{9-ii}
...
\bigtitle{Troisième nocturne}{Dimanche 30 novembre}{Matines}

\gscore{an_gabriel_angelus_ave}{L’Ange Gabriel parla à Marie, disant : Je te salue, pleine de grâce, le Seigneur est avec toi, tu es bénie entre les femmes.}
\psalmVulgate{9-iii}
\gscore{an_maria_dixit}{Marie dit : que veut dire cette salutation ? Car mon âme a été troublée, et que je dois enfanter un Roi qui ne violera pas ma virginité.}
\psalmVulgate{9-iv}
\gscore{an_in_adventu}{En l’avènement du souverain Roi, que les cœurs des hommes soient purifiés, que nous marchions dignement à sa rencontre : car voici qu’il vient, et il ne tardera pas.}
\psalmVulgate{10}
...
\absolutio{A vínculis peccató\syprep{rum} \sylprep{nos}\sylac{tró}rum~\psstar{} absólvat nos omnípotens et miséricors Dóminus.}{Que le Dieu tout-puissant et miséricordieux daigne nous délivrer des liens de nos péchés.}
...
\gscore{re_ecce_dies}{Voilà que des jours viennent, dit le Seigneur, et je susciterai à David un germe juste ; un Roi régnera, il sera sage, et il rendra le jugement et la justice sur la terre : Et voici le nom dont on l’appellera: Le Seigneur, notre juste. \vv En ces jours- là Juda sera sauvé, et Israël habitera en assurance.}
