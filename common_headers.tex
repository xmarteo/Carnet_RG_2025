...
\newcommand{\psalmVulgate}[2][\nextpsalmmode]{
	...
	#2 numéro du psaume
	\twocolitemizedtext{psalmi_vulgata/#2-#1.tex}{psalmi_fr/#2.tex}{Psaume #2}
}

\newcommand{\psalmNova}[2][\nextpsalmmode]{
	#1 (optionnel) : mode+differentia. par défaut: mode de la dernière pièce gabc parsée.
	#2 numéro du psaume
	\twocolitemizedtext{psalmi_nova/#2-#1.tex}{psalmi_fr/#2.tex}{Psaume #2}
}
...
\newcommand{\canticumVulgate}[3][\nextpsalmmode]{
	...
	#3 titre du cantique
	\twocolitemizedtext{psalmi_vulgata/#2-#1.tex}{psalmi_fr/#2.tex}{Cantique #3}
}
...
\newcommand{\canticumNova}[3][\nextpsalmmode]{
	...
	#2 nom de fichier associé au cantique
	#3 titre du cantique
	\twocolitemizedtext{psalmi_nova/#2-#1.tex}{psalmi_fr/#2.tex}{Cantique #3}
}
...
\smalltitle{Capitule}\hfill\rubric{#1}
\twocoltext{#2}{#3}
}
